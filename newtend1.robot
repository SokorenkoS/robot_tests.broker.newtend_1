...
Підготувати клієнт для користувача
  ...
  #Run Keyword If   '${USERS.users['${username}']}'!= 'Newtend_Viewer'   Login
  #${username} != 'Newtend_Viewer'

Login
  [Arguments]  @{ARGUMENTS}
  Wait Until Page Contains Element   id=open-enter-modal-btn   20
  Click Element   id=open-enter-modal-btn
  Wait Until Page Contains Element   id=input_94   20
  Click Element   id=input_93
  Input text   id=input_93   ${USERS.users['${ARGUMENTS[0]}'].login}
  Input text   id=input_94   ${USERS.users['${ARGUMENTS[0]}'].password}
  Click Element   //*[@id="menu_container_95"]/md-menu-content/user-login-form/form/md-input-container[3]/button
